<x-app-layout>
    <h1 class="w-full text-3xl text-black pb-6">Edit Penjualan</h1>

    <div class="flex flex-wrap">
        <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
            <p class="text-xl pb-6 flex items-center">
                <i class="fas fa-list mr-3"></i> Edit Form Penjualan
            </p>
                ...
                <form method="POST" action="{{ route('penjualan.update', ['id' => $penjualan->id]) }}"enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="nama_produk"
                                ...
                                type="text" name="nama_produk" value="{{$penjualan->nama_produk}}" required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="ukuran"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            type="text" name="ukuran" value="{{$penjualan->ukuran}}" required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="harga_produk"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            type="number" name="harga_produk" value="{{$penjualan->harga_produk}}" required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="jenis_produk"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            type="text" name="jenis_produk" value="{{$penjualan->nama_produk}}" required />
